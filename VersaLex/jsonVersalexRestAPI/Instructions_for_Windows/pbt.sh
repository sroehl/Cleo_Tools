...
cp /c/git/repo/Cleo_Tools/VersaLex/jsonVersalexRestAPI/tools/HarmonyCSVToJSON/templates/AS2Template.csv /c/profilebuildertool/AS2Template.csv
cp /c/git/repo/Cleo_Tools/VersaLex/jsonVersalexRestAPI/tools/HarmonyCSVToJSON/templates/FTPTemplate.csv /c/profilebuildertool/FTPTemplate.csv
cp /c/git/repo/Cleo_Tools/VersaLex/jsonVersalexRestAPI/tools/HarmonyCSVToJSON/templates/SFTPTemplate.csv /c/profilebuildertool/SFTPTemplate.csv
